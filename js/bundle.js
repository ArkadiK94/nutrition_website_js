...
function calculatur() {
  //calculator
  var weight, hight, age, sex, retio;
  ...
  function getDymanicData(id) {
    var data = document.querySelector("#".concat(id));
...
/* harmony import */ var _trigers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./trigers */ "./js/modules/trigers.js");
...
function form(formSelector, modalWindow, modalSelector, openModal) {
  //post data to server
  var formInPage = document.querySelectorAll(formSelector),
      modal = document.querySelector(modalSelector);
  formInPage.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      var divMassege = document.createElement("img");
  ...
  function showModalAnswer(massage) {
    var prevModal = document.querySelector(modalWindow);
    prevModal.classList.add("hide");
    (0,_trigers__WEBPACK_IMPORTED_MODULE_10__.showModal)(modalSelector, openModal);
    ...
    setTimeout(function () {
      ...
      newModal.remove();
      (0,_trigers__WEBPACK_IMPORTED_MODULE_10__.hideModal)(modalSelector);
    }, 2000);
  }
}
...
function menuTabs(container) {
  ...
  var MenuTabs = /*#__PURE__*/function () {
    function MenuTabs(name, img, text, price, place) {
  ...
  var tabsInMenu = document.querySelectorAll(container);
  tabsInMenu[4].innerHTML = "";
  (0,_services_services__WEBPACK_IMPORTED_MODULE_4__.getData)("http://localhost:3000/menu").then(function (data) {
...
function slider(_ref) {
  var sliderNextSelector = _ref.sliderNextSelector,
      sliderPrevSelector = _ref.sliderPrevSelector,
      slidersSelector = _ref.slidersSelector,
      counterSliderSelector = _ref.counterSliderSelector,
      sliderWrapperSelector = _ref.sliderWrapperSelector,
      sliderFiledSelector = _ref.sliderFiledSelector,
      allSliderSelector = _ref.allSliderSelector;
  ...
  function cheking(value, classOfPlace) {
    if (value < 10) {
      counterSlider.querySelector(classOfPlace).textContent = "0".concat(value);
    } else {
      counterSlider.querySelector(classOfPlace).textContent = "".concat(value);
    }
  }
  ...
  for (var i = 0; i < sliders.length; i++) {
    divForDots.innerHTML += "\n        <div class=\"dot\" data-current=\"".concat(i, "\"></div>\n        ");
  }

  var currentDot = divForDots.querySelectorAll("[data-current]");

  var markDot = function markDot() {
    currentDot.forEach(function (item) {
  ...
  markDot();
  currentDot.forEach(function (item, i) {
    item.addEventListener("click", function (event) {
      offSet = +width.slice(0, width.length - 2) * i;
      indexSlider = i;
      cheking(indexSlider + 1, "#current");
      sliderFiled.style.transform = "translateX(-".concat(offSet, "px)");
      markDot();
    });
  });
  counterSlider.addEventListener('click', function (event) {
...
function trigers(modalTrigersSelector, modalCloseSelector, modalSelector, openModal) {
  ...
  var modalTrigers = document.querySelectorAll(modalTrigersSelector),
      modalClose = document.querySelector(modalCloseSelector),
      modal = document.querySelector(modalSelector);
  modalTrigers.forEach(function (item, i) {
    item.addEventListener("click", function () {
      return showModal(modalSelector, openModal);
    });
  });
  modalClose.addEventListener("click", function () {
    return hideModal(modalSelector);
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_calculatur__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/calculatur */ "./js/modules/calculatur.js");
/* harmony import */ var _modules_menu_tabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/menu_tabs */ "./js/modules/menu_tabs.js");
...
/* harmony import */ var _modules_trigers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/trigers */ "./js/modules/trigers.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var openModal = setTimeout(function () {
    return (0,_modules_trigers__WEBPACK_IMPORTED_MODULE_5__.showModal)(".modal", openModal);
  }, 6000);
  (0,_modules_calculatur__WEBPACK_IMPORTED_MODULE_0__.default)();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("couldnt fetch url ".concat(url, " status ").concat(res.status));
